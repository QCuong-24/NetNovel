    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
            ...
            .authorizeHttpRequests(auth -> auth
                ...
                .requestMatchers(HttpMethod.GET, "/api/audio/voices").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/audio-assets/*").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/audio-assets/*/file").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/novel-rankings/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/comments/**").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/recommendations/for-you").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/recommendations/novels/*/similar").permitAll()
                .requestMatchers(HttpMethod.GET, "/api/recommendations/novels/*/similar/semantic").authenticated()
                .requestMatchers(HttpMethod.GET, "/api/recommendations/novels/*/similar/hybrid").hasAnyRole("MANAGER", "ADMIN")
